<h2><a href="https://leetcode.com/problems/remove-digit-from-number-to-maximize-result/description/?envType=problem-list-v2&envId=greedy">2337. Remove Digit From Number to Maximize Result</a></h2><h3>Easy</h3><hr><p>You are given a string <code>number</code> representing a <strong>positive integer</strong> and a character <code>digit</code>.</p>
